package com.verticles.verticles;

import com.verticles.AuthorizedUser;
import com.verticles.IncomingData;
...
public class HttpVerticle extends AbstractVerticle {
  ...
  public HttpVerticle(Set<String> apiKeys, Map<String, String> users) {
